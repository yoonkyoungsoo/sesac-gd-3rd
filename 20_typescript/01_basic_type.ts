...
// isTrue2 = 'aa' // isTrue2 변수는 boolean 타입이라고 직접 작성하지 않아도
...
let arr3: (number[] | boolean | null)[] = [true, null, false, [4, 22]];
let arr4: Array<number[] | boolean | null> = [true, null, false, [4, 22]];
